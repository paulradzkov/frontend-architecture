...
В файле настроек могут быть глобальные переменные проекта и переопределения настроек компонентов. Порядок следования миксинов не важен, главное чтобы миксин с настройками вызывался после импорта своего файла компонента.
...
.mycomponent-settings() {
    ...
    // we can do hotfix for component elements
    &-part {
